...
#   Hint: Circle Area = π r^2 Water in the pond = Pond AreaWater per Square Meter 
...
#3. If you cross a 490meterlong street in 7 minutes, calculate your speed in meters per second. 
